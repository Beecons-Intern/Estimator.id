...
class PenggunaModel {
  ...
  Map<String, Object?> toJson() => {
        PenggunaFields.namaPengguna: namaPengguna,
        PenggunaFields.profil: profil,
        PenggunaFields.alamat: alamat,
        PenggunaFields.idWilayah: idWilayah,
        PenggunaFields.perusahaan: perusahaan,
        PenggunaFields.email: email,
        PenggunaFields.noTelp: noTelp,
        PenggunaFields.noWa: noWa,
        PenggunaFields.website: website,
        PenggunaFields.hargaMin: hargaMin,
        PenggunaFields.hargaMax: hargaMax,
        PenggunaFields.nego: nego,
        PenggunaFields.username: username,
        PenggunaFields.password: password,
        PenggunaFields.foto: foto,
        PenggunaFields.kategoriAkun: kategoriAkun,
        PenggunaFields.jenisAkun: jenisAkun,
        PenggunaFields.status: status,
        PenggunaFields.kodeVerifikasi: kodeVerifikasi,
        PenggunaFields.statusVerifikasi: statusVerifikasi,
        PenggunaFields.tglDaftar: tglDaftar,
        PenggunaFields.jamDaftar: jamDaftar
      };
}
